                                                                            ...
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable">
                                                                                    <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#1A54BA;'>
                                                                                        <span class="font">{{COMPANY_NAME}}</span>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
                                                                            Can&rsquo;t remember your LDE Admin Panel password? No problem &minus; it happens. Please use the below link to reset your password within the next 5 days:	<br>
                                                                            <br>
                                                                            If clicking the link below does not work,<br>
                                                                            please copy and paste the URL in a new browser window instead. <br>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        <td align='center' bgcolor='#1A54BA' style='background:#1A54BA; padding:15px 18px;-webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px;'>
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <a target='_blank' href='{{RESETLINK}}' class='link2' style='color:#ffffff;'>Reset password</a>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                            ...
                                                                            <div class="contentEditableContainer contentTextEditable">
                                                                                <div class="contentEditable" align='center'>
                                                                                    <p style='text-align:left;color:#CCCCCC;font-size:12px;font-weight:normal;line-height:20px;'>
                                                                                        ...
                                                                                        <br>
                                                                                        <a target='_blank' class='link1' class='color:#382F2E;' href="{{SHOWEMAIL}}">Show this
